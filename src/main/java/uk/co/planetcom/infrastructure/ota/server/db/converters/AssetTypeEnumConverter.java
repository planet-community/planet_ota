...
@Converter
public class AssetTypeEnumConverter implements AttributeConverter<AssetTypeEnum, String> {
    @Override
    public String convertToDatabaseColumn(AssetTypeEnum assetTypeEnum) {
    ...
    @Override
    public AssetTypeEnum convertToEntityAttribute(String s) {
